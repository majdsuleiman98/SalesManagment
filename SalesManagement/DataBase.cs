...
namespace SalesManagement
{
    ...
    class DataBase
    {
        SqlConnection Conn = new SqlConnection("server=DESKTOP-IPR2HMP; database=Sales_System; Integrated Security=True");
        SqlCommand Cmd = new SqlCommand();
        //veritabanındaki verileri okuyacaktır(select statement)
        //ExecuteData fonkisyonu istediğimiz verileri tablo olarak (datatable) döndürecektir. 
        public DataTable ExecuteData(String stmt)
        {
        ...
        //ExecuteData method overloading
