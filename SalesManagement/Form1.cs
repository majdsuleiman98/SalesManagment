...
namespace SalesManagement
{
    public partial class Form1 : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                User_ID = Convert.ToInt32(db.ExecuteData("select * from Users where User_Name='"+Properties.Settings.Default.USERNAME+"'").Rows[0][0]);
        ...
        private bool CheckUser(string colum,string table)
        {
            ...
            tablesearch = db.ExecuteData("select "+ colum + " from "+ table + " where User_ID=" + User_ID + "");
